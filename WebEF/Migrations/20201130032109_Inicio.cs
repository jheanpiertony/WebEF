        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActorPelicula_Actor_ActorId",
                        column: x => x.ActorId,
                        principalSchema: "dbo",
                    ...
                    table.ForeignKey(
                        name: "FK_ActorPelicula_Pelicula_PeliculaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Direccion_Actor_ActorId",
                        column: x => x.ActorId,
                        principalSchema: "dbo",
                        principalTable: "Actor",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nrotarjeta = table.Column<string>(fixedLength: true, maxLength: 16, nullable: true),
                    ActorId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TarjetaCredito_Actor_ActorId",
                        column: x => x.ActorId,
                        principalSchema: "dbo",
                        principalTable: "Actor",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActorPelicula_PeliculaId",
                table: "ActorPelicula",
                column: "PeliculaId");

            migrationBuilder.CreateIndex(
                name: "IX_Direccion_ActorId",
                table: "Direccion",
                column: "ActorId");

            migrationBuilder.CreateIndex(
                name: "IX_TarjetaCredito_ActorId",
                table: "TarjetaCredito",
                column: "ActorId",
                unique: true);
        }
